...
var iframeReady=function(){console.log(submitted);submitted&&$.alert({title:"Success",type:"green",content:"You order was successfull. Thank you!",buttons:{Ok:function(){window.location.reload()}}})},closePreview=function(){$(".display-upload").hide();$(".upload-btn").show();$(".upload-preview img").attr("src","");$('.upload-preview input[type="hidden"].deposit-slip').val("")},saveToCloud=function(a){$.post("http://115.84.230.78/upload.php",{file:a},function(a){a=eval("("+a+")");disableInput(!1);

...
var validateDeposit=function(){var a=!1;disableInput(!0);$(".error-msg").remove();$("#input-reference").val().trim()||(addErrorMsgToElementGroup($("#input-reference").parent(),"#input-reference","Please enter your Donation reference"),a=!0);$("#input-deposit-slip").val().trim()||(addErrorMsgToElementGroup($("#input-reference").parent().parent().parent(),"#input-deposit-slip","Please upload your deposit slip"),a=!0);a?($.alert({title:"Error",type:"red",content:"Please correct the error(s) in the form to continue placing an order"}),

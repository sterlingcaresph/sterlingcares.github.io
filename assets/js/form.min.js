...
Date.now())},prepareForm=function(){$(".input-form").each(function(){$(".real-form").find("#"+$(this).attr("id").replace("input-","")).hasClass("populatable")&&$(".real-form").find("#"+$(this).attr("id").replace("input-","")).val($(this).val())});prepareBeneficiaries();var a=uuid(),b=0,c=0;$(".beneficiaries .beneficiary").each(function(){b+=parseInt($(this).find(".input-qty").val());c+=4200*c});$("#amount").val(c);$(".real-form #total-box").val(b);setCookie("reference",a,30);setCookie("total",getOrderTotal(),
...
typeof $(a).find(".input-pickup:checked").val()?(addErrorMsgToElementGroup(a,".input-shipping-mode","Please select a branch where you want to pickup your order"),!0):!1},validateDelivery=function(a){return $(a).find(".input-address").val()?!1:(addErrorMsgToElementGroup(a,".input-shipping-mode","Please enter your delivery address"),!0)},addErrorMsgToElementGroup=function(a,b,c){$(a).find(b).parents().each(function(){$(this).hasClass("form-group")&&($(this).append('<div class="error-msg"><small class="text-danger">'+

...
Date.now())},prepareForm=function(){$(".input-form").each(function(){$(".real-form").find("#"+$(this).attr("id").replace("input-","")).hasClass("populatable")&&$(".real-form").find("#"+$(this).attr("id").replace("input-","")).val($(this).val())});prepareBeneficiaries();var a=uuid(),b=0,c=0;$(".beneficiaries .beneficiary").each(function(){b+=parseInt($(this).find(".input-qty").val());c+=4200*parseInt($(this).find(".input-qty").val())});$("#amount").val(c.join(" / "));$(".real-form #total-box").val(b);
